...
void main(void)
{
    ...
    *IX = 1; /* X se modifica, ahora vale 1. */
    printf("nX = %d \t Y = %d \t Z[0] = %d \t Z[1] = %d \t Z[2] = %d \t Z[3] = %d \t Z[4] = %d", X, Y, Z[0], Z[1], Z[2], Z[3], Z[4]);
    ...
    *IX = *IX - 5; /* Z[2] se modifica, ahora vale 10. */
    ...
    ++*IX; /* Z[2] se modifica, se incrementa 3n 1. Z[2] ahora vale 11. */
    *IX += 1; /* Z[2] se vuelve a modificar, ahora vale 12. */
    ...
    ahora IX apunta al cuadro elemnto de Z (Z[3]). */
    ...
    */ Y = *IX; /* Y se modifica, toma l valor (basura) de una celda incorrecta.
    Es un error que no senala el compilador del lenguaje C. */
    printf("\nX = %d \t Y = %d \t Z[0]= %d \t Z[1] = %d \t Z[2] = %d \t Z[3] = %d \t Z [4] = %d", X, Y, Z[0], Z[1], Z[2], Z[3], Z[4]);
