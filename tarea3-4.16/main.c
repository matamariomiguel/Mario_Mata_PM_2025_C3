...
void Minima(float, int);   /* Prototipos de funciones. */
...
modifique su contenido. HMAX y HMIN se utilizarán para almacenar el
...
void main(void)
{
    ...
    for (I = 1; I <= 24; I++)
    {
        ...
        Acumet(TEM);
        Maxima(TEM, I);
        Minima(TEM, I);  /* Llamada a las funciones. Paso de parámetros por valor. */
    }
